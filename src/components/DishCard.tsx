    ...
    <article 
      className={cn(
        ...
        !isUnavailable && (dish.restaurant === 'restory' 
          ...
          : dish.restaurant === 'smoody'
          ? 'bg-smoody-background hover:border-smoody-primary/50 border-smoody-accent/30'
        ...
        dish.restaurant === 'smoody' && 'bg-smoody-background border-smoody-accent/30'
      )}
            ...
            <div className={cn(
              ...
              <div className="text-center p-6">
                ...
                <div className={cn(
                  ...
                  dish.restaurant === 'smoody' ? 'text-smoody-primary' : 'text-nirvana-accent'
                )}>
        ...
        <div className="p-4">
          <div className="flex justify-between items-start gap-2 mb-2">
            <h3 className={cn(
              ...
              dish.restaurant === 'smoody' ? 'text-black' : 'text-white',
          ...
          <div className="flex items-center justify-between">
            <span className={cn(
              ...
              dish.restaurant === 'restory' 
                ...
                : dish.restaurant === 'smoody'
                ? 'bg-smoody-secondary/20 text-smoody-secondary'
