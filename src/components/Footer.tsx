  ...
  return (
    <>
      <footer className={getFooterClasses()}>
        <div className="max-w-7xl mx-auto px-4 py-12 bg-[sidebar-primary-foreground] bg-zinc-800 text-zinc-400">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-zinc-400">{t('footer.visitUs')}</h3>
