...
const MenuDisplay = ({
  ...
  return <div className={cn('min-h-screen pb-20 bg-white')}>
      <div className="container mx-auto px-4 py-6">
        ...
        {/* Dishes Grid */}
        {filteredDishes.length > 0 ? <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-4">
