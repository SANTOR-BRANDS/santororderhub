        ...
        /> : <section className="min-h-[80vh] flex items-center justify-center bg-gradient-santor text-santor-foreground">
            ...
            <nav aria-label="Restaurant selection" className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <article className="flex flex-col items-center gap-3 cursor-pointer group" onClick={() => setSelectedRestaurant('restory')}>
                <div className="w-full aspect-[3/1] rounded-full bg-white/10 backdrop-blur-sm border border-white/20 overflow-hidden transition-smooth group-hover:bg-white/20 flex items-center justify-center p-4">
