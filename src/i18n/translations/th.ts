...
export const thTranslations = {
  ...
  'dish.smoody.extraScoop': 'เพิ่มควอร์ต',
  'dish.smoody.addScoop': 'เพิ่มไอศกรีม',
  'EXT-SAU-001': 'เพิ่มน้ำผึ้งแท้ (+15)',
  'EXT-GRK-001': 'กรีกโย เพิ่มควอร์ต',
  // Fruits
  'EXT-FRU-001': 'กล้วย',
  'EXT-FRU-002': 'กีวี่',
  'EXT-FRU-003': 'แก้วมังกร',
  'EXT-FRU-004': 'มะม่วง',
  'EXT-FRU-005': 'แอปเปิ้ล',
  'EXT-FRU-006': 'สับปะรด',
  'EXT-FRU-007': 'องุ่นมัสกัต',
  'EXT-FRU-008': 'บลูเบอร์รี่',
  'EXT-FRU-009': 'สตรอว์เบอร์รี่',
  'EXT-FRU-010': 'อะโวคาโด',
  // Nuts & Seeds
  'EXT-NUT-001': 'เมล็ดเชีย',
  'EXT-NUT-002': 'เมล็ดแฟล็กซ์',
  'EXT-NUT-003': 'มะพร้าวขูด',
  'EXT-NUT-004': 'คาโก �นิบส์',
  'EXT-NUT-005': 'ช็อกชิปส์',
  'EXT-NUT-006': 'ลูกเกด',
  'EXT-NUT-007': 'โอริโอ้',
  'EXT-NUT-008': 'คอร์นเฟลกส์',
  'EXT-NUT-009': 'โฮมเมดแกรนโลล่า',
  'EXT-NUT-010': 'เม็ดมะม่วง',
  'EXT-NUT-011': 'อัลมอนด์',
  // Sauces
  'EXT-SAU-002': 'คาราเมล',
  'EXT-SAU-003': 'ช็อกโกแลต',
  'EXT-SAU-004': 'เนยถั่ว',
  'EXT-SAU-005': 'ช็อกโกแลตเนยถั่ว',
