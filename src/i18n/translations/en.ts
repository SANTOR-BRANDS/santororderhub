...
export const enTranslations = {
  ...
  'dish.smoody.extraScoop': 'EXTRA SCOOP',
  'dish.smoody.addScoop': 'ADD SCOOP',
  'EXT-SAU-001': 'Extra Natural Honey (+15)',
  'EXT-GRK-001': 'Greek Yo Extra Scoop',
  // Fruits
  'EXT-FRU-001': 'Banana',
  'EXT-FRU-002': 'Kiwi',
  'EXT-FRU-003': 'Dragon Fruit',
  'EXT-FRU-004': 'Mango',
  'EXT-FRU-005': 'Apple',
  'EXT-FRU-006': 'Pineapple',
  'EXT-FRU-007': 'Shine Muscat Grape',
  'EXT-FRU-008': 'Blueberry',
  'EXT-FRU-009': 'Strawberry',
  'EXT-FRU-010': 'Avocado',
  // Nuts & Seeds
  'EXT-NUT-001': 'Chia Seeds',
  'EXT-NUT-002': 'Flax Seeds',
  'EXT-NUT-003': 'Coconut Shred',
  'EXT-NUT-004': 'Cacao Nibs',
  'EXT-NUT-005': 'Choco Chips',
  'EXT-NUT-006': 'Raisins',
  'EXT-NUT-007': 'Oreo',
  'EXT-NUT-008': 'Corn Flakes',
  'EXT-NUT-009': 'Homemade Granola',
  'EXT-NUT-010': 'Cashew Nuts',
  'EXT-NUT-011': 'Almonds',
  // Sauces
  'EXT-SAU-002': 'Caramel',
  'EXT-SAU-003': 'Chocolate',
  'EXT-SAU-004': 'Peanut Butter',
  'EXT-SAU-005': 'Choco Peanut Butter',
  ...
  'category.signatureBowls': 'SIGNATURE BOWLS',
  'category.greekYo': 'GREEK YO',
